...
const pauseSvg = `
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pause pause" viewBox="0 0 16 16">
...
const homeSvg = `
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi home" viewBox="0 0 16 16">
...
const musicIconSvgOptional = `
	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-music-note-beamed music_icon-optional" viewBox="0 0 16 16">
