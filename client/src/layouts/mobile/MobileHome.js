...
const MobileHome = async () => {
	const MobileHome = new CreateElement("section");

	// Set attributes
	MobileHome.addClass("home-section", "main-sections").setId("home-section");
	...
	MobileHome.appendChild(homeContent.authGate);

	return MobileHome.getElement();
};
