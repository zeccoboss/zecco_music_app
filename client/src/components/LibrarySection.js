	...
	librarySection.innerHTML = `
		<div class="empty_lib_content show_lib_content">
			...
			<div>
				...
				<p>To access your library  <a href="/register" class="lib_links">Sign up</a> to continue or <a href="/login" class="lib_links">Login</a> to access all features.</p> 
				<div class="lib_lnks_ctn">
					<a href="/register" class="lib_links">Sign up</a>
